...
This is not a recommended implementation but it's setup is [documented here](https://github.com/hereishd/K8S-From-Scratch/tree/main/Nginx-Ingress-Controller/Nginx-Load-Balancer-Reverse-Proxy/Reverse-Proxy-Setup) as reference under the 'Configuring/Installing the NGINX Ingress Controller with NodePort service
<br/><br/>
...
* [Deploy NGINX as reverse proxy](https://github.com/hereishd/K8S-From-Scratch/tree/main/Nginx-Ingress-Controller/Nginx-Load-Balancer-Reverse-Proxy/Reverse-Proxy-Setup) (exposing your NGINX controller with NodePort service)
